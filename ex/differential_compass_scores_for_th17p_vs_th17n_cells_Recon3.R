# Reproduces Fig. 2(c) from our paper. (This script works out-of-the-box with the Th17 cell data set included in the package.)
...
compass_settings <- CompassSettings$new(
    ...
    user_data_directory = "~/yosef-lab/Recon3Output",
